...
import 'package:explore_uganda/home/profile/morePages/image_view.dart';
...
class AdminChatPage extends StatefulWidget {
  ...
  String? name;
  String? chatId;
  AdminChatPage({super.key, this.url, this.name, this.chatId});
    ...
    return Align(
      ...
      MaterialPageRoute(
        builder: (context) => GalleryPhotoViewWrapper(
          galleryItems: message.imagesList!,
